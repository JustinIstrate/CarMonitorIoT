...
* **Interactive Dashboard:** A reactive web interface that updates values instantly without requiring page reloads.
* **Live Charts:** Integrates **Chart.js** to visualize engine RPM fluctuations in real-time.
...
* **Diagnostic System (OBD2 Log):** Built-in memory that logs error codes triggered during operation and generates a comprehensive diagnostic report when the engine stops.
...
## 🚀 How to Run Locally
1. Clone this repository: `git clone https://github.com/JustinIstrate/CarMonitorIoT.git`
